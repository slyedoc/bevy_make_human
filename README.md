...
Assets are from mpfb2 repo data and make human community [Asset Packs](https://static.makehumancommunity.org/assets/assetpacks.html):
...
## TODO
  ...
  - [ ] Shared meshes, currently applying morphies by constructing new mesh, so in effect every mesh is unique.  Materials should still be be shared though.
